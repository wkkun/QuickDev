package com.example.basefunction.widget
...
import com.example.basefunction.R
import com.example.basefunction.databinding.ItemCustomTitleBinding
...
class CustomTitleView(context: Context, attributeSet: AttributeSet? = null) :
    ...
    private val defaultHeight: Int =
        context.resources.getDimensionPixelOffset(com.example.screensupport.R.dimen.dp_44)
